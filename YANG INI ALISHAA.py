...
class ACseRemind:
    ...
    def __init__ (self,window):
        ...
        #======= LOG IN =======#
        self.label_username = Label(window, text="Username", bg = "#ecf0f3", font=("sans serif",12,"bold"),fg="#0370a9").place(x=410,y=400)
        self.entry_username = Entry(window, textvariable=self.username,border=0,highlightthickness=2,highlightcolor="#0370a9",relief="groove", width=38, font=("Sans serif",19),bg="white",fg="#0370a9").place(x=410, y=425)


        self.label_password = Label(window, text="Password", bg = "#ecf0f3", font=("sans serif",12,"bold"),fg="#0370a9").place(x=410,y=490)
        self.entry_password = Entry(window, textvariable=self.password,border=0,highlightthickness=2,highlightcolor="#0370a9",relief="groove", width=38, font=("Sans serif",19),bg="white",fg="#0370a9",show='*')
        self.entry_password.place(x=410, y=530)

        self.button_lupapsw = Button(window,text="Forgot Password?",bg = "#ecf0f3", font=("sans serif",10,"underline"),fg="blue",command=self.forgot_password,
                                     highlightbackground="#75bfd5",highlightcolor="#75bfd5",highlightthickness=0,border=0,borderwidth=0).place(x=840,y=585)
        
        self.label_gapunya_akun = Label(window,text="Don't have a account?",bg = "#ecf0f3", font=("sans serif",10),fg="black").place(x=430,y=610)
        self.button_sign_in = Button(window,text="Sign in",bg = "#ecf0f3", font=("sans serif",10,"bold underline"),fg="blue",command=self.show_sign_in_window,
                                     highlightbackground="#75bfd5",highlightcolor="#75bfd5",highlightthickness=0,border=0,borderwidth=0).place(x=560,y=610)
        
        ctk.set_appearance_mode("System")
        ctk.set_default_color_theme("blue")
        self.button_login = ctk.CTkButton(window,command=self.login,text="LOGIN",corner_radius=20,hover_color='green',fg_color='#0370a9',bg_color="#ecf0f3",width=480,height=40)
        self.button_login.place(x=430,y=640)
        

        showpsw = Checkbutton(window, bg="#ecf0f3", command=self.show_psw, text="show password",font=("sans serif",10))
        showpsw.place(x=415,y=585)
            ...
            with open('dataservice.csv', 'r') as file:
                ...
                for row in reader:
                    ...
                    if row['Username'] == username and row['Password'] == password:
                        ...
                        self.dashboard()  # Call the dashboard method or perform other actions
                        return
...
#===========DASHBOARD========#
        ...
        with open('dataservice.csv', mode='r') as file:
            ...
            for row in csv_reader:
                if row['Username'] == username:
                    ...
                    self.nama_label_dshbrd = Label(window,text=f"Welcome {first_name} {last_name}!\nto S.TECH\nAC Service Reminder", font=("Times", 25, "bold"),bg='#ecf0f3',justify='left',fg='black')
                    self.nama_label_dshbrd.place(x=80,y=140)
    ...
    #==================JASA SERVICE===============#
        ...
        self.button_jasa_A.place(x=780,y=250)
        ...
        self.button_jasa_B.place(x=1020,y=250)
        ...
        self.button_jasa_C.place(x=780,y=480)
        ...
        self.button_jasa_D.place(x=1020,y=480)
        ...
        self.button_reminder.place(x=1015,y=110)

        self.button_booking=Button(window, command=self.riwayat_booking,text="Booking\nHistory",bg="#ecf0f3",foreground="blue" ,font=("Arial MT Rounded",12,"bold underline"), relief="flat",activebackground="#012554", activeforeground="light blue", border = 0)
        self.button_booking.place(x=800,y=110)

        self.button_booking=Button(window,command=self.konsul,text="AC\nConsultation",bg="#ecf0f3",foreground="blue" ,font=("Arial MT Rounded",12,"bold underline"), relief="flat",activebackground="#012554", activeforeground="light blue", border = 0)
        self.button_booking.place(x=570,y=110)
    
    def konsul(self):
        
        self.frame_konsul= ctk.CTkFrame(window, corner_radius=20, bg_color='#ecf0f3', fg_color='#f8f8f8', width=500, height=530)
        self.frame_konsul.place(x=740, y=180)

    
        self.image = PhotoImage(file="konsul.png")
        Label(self.frame_konsul,image=self.image).place(x=2,y=8)
        ...
        booking_button.place(x=340,y=500)
        close_button = ctk.CTkButton(self.frame_konsul,width=100, text="Close", command=self.frame_konsul.destroy)
        close_button.place(x=50,y=500)
    def konsul2(self): 
        ...
        close_button = ctk.CTkButton(frame_konsul1,width=100, text="Close", command=frame_konsul1.destroy)
        close_button.place(x=220,y=480)
    
    def jasa(self,button_id):
        global jasa_A_frame

        jasa_A_frame= ctk.CTkFrame(window, corner_radius=20, bg_color='#ecf0f3', fg_color='#f8f8f8', width=500, height=530)
        jasa_A_frame.place(x=740, y=180)

    
        self.image = PhotoImage(file="service.png")
        Label(jasa_A_frame,image=self.image).place(x=2,y=8)

        if button_id == 1: 
            Servis_Cuci = Label(jasa_A_frame,text="BOTANIA",font=("Arial Rounded MT Bold",11,"bold"),bg='#f8f8f8',fg="#072D44")
            ...
            booking_button.place(x=340,y=480)
            close_button = ctk.CTkButton(jasa_A_frame,width=100, text="Close", command=jasa_A_frame.destroy)
            close_button.place(x=50,y=480)
            
        elif button_id == 2: 
            Servis_Cuci = Label(jasa_A_frame,text="ACTECH",font=("Arial Rounded MT Bold",11,"bold"),bg='#f8f8f8',fg="#072D44")
            Servis_Cuci.place(x=35,y=80)
            ...
            Servis_Cuci = Label(jasa_A_frame,text="BORCHELLE",font=("Arial Rounded MT Bold",11,"bold"),bg='#f8f8f8',fg="#072D44")
            Servis_Cuci.place(x=35,y=80)
            ...
            Servis_Cuci = Label(jasa_A_frame,text="JAYA",font=("Arial Rounded MT Bold",11,"bold"),bg='#f8f8f8',fg="#072D44")
            Servis_Cuci.place(x=35,y=80)
...
# class BookingForm:
    def booking(self,button_id):
        ...
        self.label_nama_booking = ctk.CTkLabel(frame_booking, text='Username', font=("Times", 15, "bold"), bg_color="#1679ad", text_color='white')
        self.label_nama_booking.place(x=60, y=75)

        self.entry_nama_booking = ctk.CTkLabel(frame_booking, width=250, corner_radius=20, textvariable=self.username, font=("Times", 20), fg_color="#f8f8f8", text_color="black")
...
# Function to calculate the total price based on the selected services
            ...
            if not all([self.alamat.get(), self.no_Hp.get(), self.tanggal_booking.get(), self.nama_jasa]):
                ...
                for service, price in service_prices.items():
                    if service == "Service AC" and service_AC.get() == 1:
                        ...
                        selected_services.append("Isi Freon"), self.total_price
        ...
        button_back = ctk.CTkButton(frame_booking, text="Back", command=frame_booking.destroy, corner_radius=20, bg_color='#1679ad',border_width=1, border_color='black', font=("Times" , 15, "bold")) 
        button_back.place(x=100, y=480)
    ...
    def payment_methode(self):
            ...
            self.image2=PhotoImage(file="frame.png")
            Label(window_payment,image=self.image2).place(x=10,y=10)
            ...
            if self.pemilihanpayyy == "CASH":
                ...
                Label(window_payment,image=self.image3).place(x=150,y=80)
                ...
                a.place(x=90,y=350)
                btn = ctk.CTkButton(window_payment, width=130,height=50, text="Confirm Payment",command=self.simpan_info(1), corner_radius=20, bg_color='#f8f8f8', font=("Times" , 15, "bold")) 
                btn.place(x=187, y=430)    

            elif self.pemilihanpayyy == "QRIS":
                self.image1=PhotoImage(file="qr.png")
                Label(window_payment,image=self.image1).place(x=150,y=80)
                ctk.CTkLabel(window_payment, text=f'Anda harus bayar sebesar\nRp.{self.total_price},-',font=('Helvetica',20, 'bold')).place(x=140,y=350)
    ...
    def riwayat_booking(self):
        frame_riwayat= ctk.CTkFrame(window, corner_radius=20, bg_color='#ecf0f3', fg_color='#f8f8f8', width=500, height=530)
        frame_riwayat.place(x=740, y=180)

    
        self.image = PhotoImage(file="booking.png")
        Label(frame_riwayat,image=self.image).place(x=2,y=8)

        # frame_riwayat = ctk.CTkFrame(window, corner_radius=20, bg_color='#97bad5', border_width=3, border_color='black', fg_color='#f8f8f8', width=500, height=500)
        # frame_riwayat.place(x=750, y=140)

        # label_riwayat = Label(frame_riwayat, text="Riwayat Booking", font=("Arial Rounded MT Bold", 11, "bold"), bg='#f8f8f8', fg="#072D44")
        ...
        text_widget = scrolledtext.ScrolledText(frame_riwayat, wrap='word', width=60, height=20, font=("Arial", 10), bg='#f8f8f8', fg="#072D44")
        text_widget.place(x=35, y=110)

        if not booking_history:
            no_booking_label = Label(frame_riwayat, text="Anda belum pernah booking.", font=("Arial", 10), bg='#f8f8f8', fg="#072D44")
        ...
        ctk.CTkButton(frame_riwayat,text="Back",corner_radius=20,bg_color='#f8f8f8',hover_color='red',fg_color='#1679ad',width=100,height=50,command=frame_riwayat.destroy).place(x=50,y=430)
...
#====================REMINDER=========================#
    def reminder(self):
        ...
        self.frame_reminder= ctk.CTkFrame(window, corner_radius=20, bg_color='#ecf0f3', fg_color='#f8f8f8', width=500, height=530)
        self.frame_reminder.place(x=740, y=180)

    
        self.image = PhotoImage(file="reminder.png")
        Label(self.frame_reminder,image=self.image).place(x=2,y=8)
        ...
        self.calendar.place(x = 225, y=80)

        self.set_date_button = ctk.CTkButton(self.frame_reminder, text="Select date", width=20,command = self.Selectdate)
        self.set_date_button.place(x=320, y =282)

        self.last_service  = Label(self.frame_reminder, text="Last service", bg="#f8f8f8", font=("sans serif", 10, "bold"),fg="#0370a9").place(x=25, y=72)
        ...
        self.last_services__ket.place(x=25, y=103)

        self.email_label = Label(self.frame_reminder, text="Email", bg="#f8f8f8", font=("sans serif", 10, "bold"),fg="#0370a9").place(x=25, y=132)
        ...
        self.email_entry.place(x=25, y=168)

        self.note_label = Label(self.frame_reminder, text="Note", bg="#f8f8f8",font=("sans serif", 10, "bold"), fg="#0370a9").place(x=25, y=212)
        ...
        self.note_entry.place(x=25, y=242)
        ...
        self.set_reminder_button.place(x=75,y=282)

        cancel_reminder_button = ctk.CTkButton(self.frame_reminder, text="Cancel reminder",hover_color='red',width=350,command=self.cancel)
        cancel_reminder_button.place(x=75, y=462)   
