...
#===========DASHBOARD========#
    ...
    #  self.button_reminder=Button(window, command=self.reminder,text="Reminder",bg='#8cc6d7',fg="white", font=("Tw Cen MT Condensed Extra Bold",20),relief="flat")
        ...
        self.button_booking=Button(window, command=self.riwayat_booking,text="Riwayat booking",bg="#8cc6d7",foreground="white" ,font=("gothic",12,"bold underline"), relief="flat",activebackground="#012554", activeforeground="light blue", border = 0)
        self.button_booking.place(x=800,y=55)
...
#===============Calendar=========#
    ...
    def payment_methode(self):
        ...
        btn = ctk.CTkButton(window_payment, width=130,height=50, text="Confirm Payment",command=self.riwayat_ghaib,corner_radius=20, bg_color='#f8f8f8', font=("Times" , 15, "bold")) 
    ...
    # Create 
    # a frame for displaying booking history
            global frame_riwayat
            ...
            self.no_booking_label = Label(frame_riwayat, text="Anda belum pernah booking.", font=("Arial", 10), bg='#f8f8f8', fg="#072D44")
            self.no_booking_label.place(x=80, y=170)
                ...
                with open('booking_data.csv', mode='r') as file:
                    ...
                    # else:
                        ...
                        for booking in booking_history:
                            ...
                            messagebox.showinfo("Info!","Booking di terima")
