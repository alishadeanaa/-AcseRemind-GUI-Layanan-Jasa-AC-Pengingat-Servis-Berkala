...
# Function to calculate the total price based on the selected services
        ...
        button_back.place(x=170, y=480)
            
        btn = ctk.CTkButton(frame_booking, text="Payment", command=self.riwayat_booking, corner_radius=20, bg_color='#1679ad',border_width=1, border_color='black', font=("Times" , 15, "bold")) 
        btn.place(x=310, y=480)

    def riwayat_booking(self):
    # Create a frame for displaying booking history
        ...
        # Read booking history from a CSV file
        booking_history = []  # Assuming a list of dictionaries with booking information
        ...
        text_widget.place(x=35, y=40)

        if not booking_history:
            # If there is no booking history, display a label
            ...
            # Display booking information in the scrolled text widget
        ...
        ctk.CTkButton(frame_riwayat,text="Back",corner_radius=20,bg_color='#f8f8f8',hover_color='red',fg_color='#1679ad',width=100,height=50,command=frame_riwayat.destroy).place(x=50,y=400)
