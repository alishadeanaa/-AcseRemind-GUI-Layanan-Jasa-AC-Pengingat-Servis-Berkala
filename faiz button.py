...
class ACseRemind:
    ...
    def __init__ (self,window):
        ...
        self.button_login = customtkinter.CTkButton(window,command=self.login,text="LOGIN",corner_radius=20,hover_color='green',fg_color='#0370a9',bg_color="#92bee0",width=350)
...
#===========DASHBOARD========#
    ...
    def dashboard(self):
        ...
        username = self.username.get()
        # self.nama_dashboard = customtkinter.CTkFrame(window,width=350,height=200,bg_color='transparent')
        ...
        with open('dataservice.csv', mode='r') as file:
            ...
            for row in csv_reader:
                if row['Username'] == username:
                    ...
                    self.nama_label_dshbrd = customtkinter.CTkLabel(window,corner_radius=20,text=f"WELCOME, {first_name} {last_name}\nTO S.TECH\nAC SERVICE REMINDER!",font=("Hack",30,"bold"),fg_color='#1679ad',bg_color="#1679ad",text_color='white')
    ...
    #==================JASA SERVICE===============#
        # self.label_jasa_service = customtkinter.CTkLabel(window,corner_radius=20,text="Jasa Service AC",font=("Hack",30,"bold"),fg_color='white',bg_color='#97bad5',text_color='black')
        ...
        self.button_jasa_A = customtkinter.CTkButton(window,width=100,height=100,corner_radius=20,image=self.fotoA,hover_color='#adbec8',bg_color="#8fc5d7",fg_color="white",compound=TOP,anchor=N,text="BOTANIA Service",font=("Tw Cen MT Condensed Extra Bold",20), text_color="#2b5768")
        self.button_jasa_A.place(x=800,y=200)

        self.button_jasa_B = customtkinter.CTkButton(window,width=100,height=100,corner_radius=20,image=self.fotoB,hover_color='#adbec8',bg_color="#8fc5d7",fg_color="white",compound=TOP,anchor=N,text="ACTECH Service", font=("Tw Cen MT Condensed Extra Bold",20),text_color="#2b5768")
        self.button_jasa_B.place(x=1050,y=200)

        self.button_jasa_C = customtkinter.CTkButton(window,width=100,height=100,corner_radius=20,image=self.fotoC,hover_color='#adbec8',bg_color="#8fc5d7",fg_color="white",compound=TOP,anchor=N, text="BORCHELE Service",font=("Tw Cen MT Condensed Extra Bold",20), text_color="#2b5768")
        self.button_jasa_C.place(x=800,y=400)

        self.button_jasa_D = customtkinter.CTkButton(window,width=100,height=100,corner_radius=20,image=self.fotoD,hover_color='#adbec8',bg_color="#8fc5d7",fg_color="white",compound=TOP,anchor=N,text="JAYA service",font=("Tw Cen MT Condensed Extra Bold",20),text_color="#2b5768")
        self.button_jasa_D.place(x=1050,y=400)
    ...
    #  self.button_reminder=Button(window, command=self.reminder,text="Reminder",bg='#8cc6d7',fg="white", font=("Tw Cen MT Condensed Extra Bold",20),relief="flat")
        ...
        self.button_tentang=Button(window, command=self.reminder,text="Reminder",bg="#8cc6d7",foreground="white" ,font=("gothic",12,"bold underline"), relief="flat",activebackground="#012554", activeforeground="light blue", border = 0)
        self.button_tentang.place(x=1000,y=55)
