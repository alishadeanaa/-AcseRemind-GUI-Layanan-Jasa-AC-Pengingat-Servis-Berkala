...
class ACseRemind:
    ...
    def __init__ (self,window):
        ...
        self.a_label1=Label(window, image=self.bg).place(x=0,y=0, relheight=1,relwidth=1)
        ...
        self.button_login = customtkinter.CTkButton(window,command=self.login,text="LOGIN",font=("sans serif",12,"bold"),width=350,)
...
#=========== LUPA PASSWORD ===========#
    def forgot_password(self):
        ...
        # self.username_label = Label(window, text="Username:", bg="#f8f8f8", font=("sans serif", 10, "bold"), fg="#0370a9").place(x=50, y=50)
        # self.username_entry = Entry(window, width=38, font=("Sans serif", 13), bg="white", fg="black")
...
#===========DASHBOARD========#
    ...
    def reminder(self):
        ...
        self.set_reminder_button = customtkinter.CTkButton(self.frame_reminder, text="Set reminder",hover_color='green', width=350, command=self.sent_email)
    ...
    def sent_email(self):
        ...
        if not self.emailRemind.get() or not self.noteRemind.get():
            messagebox.showerror("Error", "Harap isi email dan catatan sebelum mengatur pengingat.")
            return
